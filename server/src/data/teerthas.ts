...
export const teerthas: CreateTeerthaPayload[] = [
  {
    ...
    staysDesc:
      "Premium accommodations near Mahakaleshwar Temple with modern amenities.",
    darshans: [
      {
        title: "Major Temples",
        items: ["Mahakaleshwar", "Kal Bhairav", "Harsiddhi Mata"],
      },
      {
        title: "Sacred Sites",
        items: ["Ram Ghat", "Sandipani Ashram", "Mangalnath Temple"],
      },
      {
...

  {
    ...
    staysDesc:
      "Traditional guesthouse accommodations overlooking the sacred Ganges river.",
    darshans: [
      {
        title: "Major Temples",
        items: ["Kashi Vishwanath", "Sankat Mochan", "Durga Temple"],
      },
      {
        title: "Sacred Ghats",
...

  {
    ...
    staysDesc:
      "Comfortable accommodations near the Jagannath temple and sea beach.",
    darshans: [
      {
        title: "Sacred Temples",
        items: ["Jagannath Temple", "Gundicha Temple", "Lokanath Temple"],
      },
      {
        title: "Holy Sites",
        items: ["Swargadwar", "Konark Sun Temple", "Markandeshwar Tank"],
      },
      {
        title: "Spiritual Experiences",
...

  {
    ...
    staysDesc:
      "Serene ashram-style accommodations overlooking the sacred Ganga river.",
    darshans: [
      {
        title: "Major Temples",
        items: ["Chandi Devi", "Mansa Devi", "Maya Devi"],
      },
      {
        title: "Sacred Ghats",
        items: ["Har Ki Pauri", "Triveni Ghat", "Kushavarta"],
      },
      {
        title: "Spiritual Experiences",
